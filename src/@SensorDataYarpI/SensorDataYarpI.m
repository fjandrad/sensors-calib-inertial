classdef SensorDataYarpI < handle
    ...
    methods(Access = protected)
        ...
        function buildSensType2portNgetter(obj)
            ...
            sensorType = {...
                'joint_from','acc_from','imu_from','fts_from','ftsMulti_from','jtorq_from,'...
                'joint_to','acc_to','imu_to','fts_to','ftsMulti_to','jtorq_to',...
                'joint_path','acc_path','imu_path','fts_path','ftsMulti_path','jtorq_path'};
            portNamingRule = {...
                ...
                eval(['@(robotname,part)' FTMultiSensors_port_rule_icub]),...
                eval(['@(robotname,part)' joints_port_rule_icub]),...
                ...
                eval(['@(robotname,part)' FTMultiSensors_port_rule_dumper]),...
                eval(['@(robotname,part)' joints_port_rule_dumper]),...
                ...
                eval(['@(datapath,part)' FTMultiSensors_folder_rule_dumper]),...
                eval(['@(datapath,part)' joints_folder_rule_dumper])};
